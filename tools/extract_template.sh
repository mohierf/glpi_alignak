...
soft='GLPI - Alignak plugin'
version='9.3 + 0.1'
email=glpi-translation@gna.org
copyright='Frédéric Mohier & Alignak Team'
...
xgettext *.php */*.php -o locales/alignak.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
