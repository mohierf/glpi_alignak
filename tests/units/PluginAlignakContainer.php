...
class PluginAlignakContainer extends \AlignakDbTestCase {

   public function testGetTypeName() {
      $this->string(\PluginAlignakContainer::getTypeName())->isIdenticalTo('Alignak');
   }

   public function testGetSearchOptions() {
      $container = new \PluginAlignakContainer();
      $this
   ...
   public function testShowFormSubtype() {
      ...
      foreach ($subtypes as $type => $pattern) {
         $form = \PluginAlignakContainer::showFormSubtype(
            [
               'type'      => 'domtab',
               'itemtype'  => $type
            ]
