...
class PluginAlignakUser extends CommonDBTM {
...
//      $this->initForm($items_id, $options);
      ...
      echo "<th colspan='4'>";
      echo __('Link a GLPI user with an Alignak backend existing user', 'alignak');
      echo "</th>";
      echo "</tr>";
      ...
      echo "<tr class='tab_bg_1'>";
      echo "<th colspan='4'>".__('OR', 'alignak')."</th>";
      echo "</tr>";
      ...
      echo "<tr class='tab_bg_1'>";
      echo "<th colspan='4'>";
      echo __('Create alignak backend account and link to this user', 'alignak');
      echo "</th>";
      echo "</tr>";
