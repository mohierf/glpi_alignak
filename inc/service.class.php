...
class PluginAlignakService extends CommonDBTM {
   ...
   function showGraphsByHost($itemtype, $items_id) {
      ...
      PluginAlignakServicegraph::loadLib();
      $pmComponentscatalog = new PluginMonitoringComponentscatalog();
   ...
   function formAcknowledge($id, $hostname = '') {
      ...
      if ($this->getFromDB($id)) {
         ...
         echo "</td>";
         echo "<td>";
         echo "<textarea cols='80' rows='4' name='acknowledge_comment' >".$this->fields['acknowledge_comment']."</textarea>";
         echo "</td>";
         echo "</tr>";
         echo "<tr class='tab_bg_1'>";
         echo "<td colspan='2' align='center'>";
